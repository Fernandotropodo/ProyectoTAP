...
import {Btnfiltro, Buscador, ContentFiltro, Header, RegistrarUsuarios, TablaUsuarios, Title, useMarcaStore, useUsuariosStore, v} from "../../index";
    ...
    <Container>
      ...
      <section className="area1">
        <ContentFiltro>
         ...
         <Btnfiltro funcion={nuevoRegistro}
         bgcolor="#f6f3f3"  
         textcolor="#353535" 
         icono={<v.agregar/>}/>
        </ContentFiltro>
