...
import { RegistrarMarca, InputText, Btnsave, ConvertirCapitalize, useProductosStore, ContainerSelector, Selector, useMarcaStore, Btnfiltro, useCategoriasStore, RegistrarCategorias } from "../../../index";
  ...
  return (
    <Container>
      <div className="sub-contenedor">
        ...
        {
          openRegistroCategoria && (<RegistrarCategorias
          dataSelect={dataSelect}
