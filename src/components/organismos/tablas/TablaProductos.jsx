...
import {ColorcontentTable, Paginacion, useProductosStore, v} from "../../../index" 
    ...
    const columns = [
      {
        ...
        header: "Descripción",
        cell: (info) => (
          <div className="ContentCell" data-title="Descripcion">
      ...
      },
      {
        ...
        enableSorting: false,
        cell: (info) => (
          <div className="ContentCell" data-title="P.venta">
            <span>{info.getValue()}</span>
          </div>
        )
      },
      {
        ...
        enableSorting: false,
        cell: (info) => (
          <div className="ContentCell" data-title="P.compra">
            <span>{info.getValue()}</span>
          </div>
        )
      },
      ...
      },
      {
        ...
        enableSorting: false,
        cell: (info) => (
          <div className="ContentCell" data-title="Marca">
            <span>{info.getValue()}</span>
          </div>
        )
      },
