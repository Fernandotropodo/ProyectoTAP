...
import {Paginacion, useUsuariosStore, v} from "../../../index" 
    ...
    const columns = [
      {
        accessorKey: "nombre",
        header: "Nombres",
        cell: (info) => <td className="ContentCell" data-title="Nombres">
      ...
      },
      {
        ...
        header: "T. User",
        cell: (info) => <td className="ContentCell" data-title="T.User">
            <span>{info.getValue()}</span>
        </td> 
      },
      {
        ...
        header: "Estado",
        enableSorting:false,
        cell: (info) => <td className="ContentCell" data-title="Estado">
            <span>{info.getValue()}</span>
        </td> 
      },
      {
