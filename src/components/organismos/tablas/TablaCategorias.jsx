...
import {Colorcontent, Paginacion, useCategoriasStore, v} from "../../../index" 
    ...
    const columns = [
      {
        ...
        header: "Descripción",
        cell: (info) => <td className="ContentCell" data-title="Descripcion">
      ...
      },
      {
        accessorKey: "color",
        header: "Color",
        cell: (info) => <td className="ContentCell" data-title="Color">
